...
@section('content')
                ...
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        ...
                        <div class="form-floating mb-4">
                            <input required="" autocomplete="off" type="text" class="form-control" id="name" name="name" placeholder="Nama User">
                            <label for="example-text-input-floating">Name</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input required="" autocomplete="off" type="text" class="form-control" id="email" name="email" placeholder="Email">
                            <label for="example-text-input-floating">Email</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input required="" autocomplete="off" type="password" class="form-control" id="password" name="password" placeholder="Password">
                            <label for="example-text-input-floating">Password</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input required="" autocomplete="off" type="password" class="form-control" id="repassword" name="repassword" placeholder="Konfirm Password">
                        ...
                        <input hidden value="1" autocomplete="off" type="text" class="form-control" id="active" name="active">
                    </div>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        ...
                        <form id="editForm">
                        <div class="form-floating mb-4">
                            <input hidden required="" autocomplete="off" type="text" class="form-control" id="id" name="id">
                            <input required="" autocomplete="off" type="text" class="form-control" id="editname" name="name" placeholder="Nama User">
                            <label for="example-text-input-floating">Name</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input required="" autocomplete="off" type="text" class="form-control" id="editemail" name="email" placeholder="Email">
                            <label for="example-text-input-floating">Email</label>
                        </div>
                        <div class="form-floating mb-4">
    ...
    <!-- END modal edit -->
     ...
     <!-- modal-reset -->
    <div class="modal fade" id="modal-reset" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default">
                    ...
                    <div class="block-content fs-sm">
                        ...
                        <form id="resetForm">
                        <div class="form-floating mb-4">
                            <input hidden required="" autocomplete="off" type="text" class="form-control" id="reset_id" name="reset_id">
                            <input id="reset_password" name="reset_password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
