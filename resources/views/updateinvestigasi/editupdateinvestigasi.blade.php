...
@section('js_after')
    ...
    <script> 
        ...
        $("#createForm").on("submit",function(e){
            e.preventDefault()
            var id = $("#id").val()
            var invest_id = $("#investigasi_id").val()
            ...
            $.ajax({
                ...
                success:function(){
                    One.helpers('jq-notify', 
                        ...
                        window.location.href = "/investigasi/"+invest_id+"/detail"
                }
            })
        })
    </script>
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <input hidden type="text" value="{{$update->investigasi_id}}" id="investigasi_id"></input>
                <div class="flex-grow-1">
                    <h2 class="h3 fw-bold mb-2">
                        Update Investigasi
                    </h2>
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                        No Case : <b>{{$update->no_case}} | {{$update->nm_perusahaan}}</b>
                    </h2>
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                        Tgl Registrasi : {{$update->tgl_registrasi}}
                    </h2>
                </div>
                ...
                <form action="" id="createForm" method="POST" class="js-validation" onsubmit="return false;">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                                <input type="text" hidden value="{{$update->id}}" id="id" class="form-control" placeholder="">
                                <input type="text" value="{{$update->tanggal}}" class="js-flatpickr form-control" id="tanggal" name="tanggal" placeholder="Y-m-d">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <select class="form-select" id="tampilkan_tgl" name="tampilkan_tgl">
                                @if ($update->tampilkan_tgl == '1')
                                    <option selected value="1">Tampilkan</option>
                                @endif

                                @if ($update->tampilkan_tgl == '0')
                                    <option selected value="0">Tidak ditampilkan</option>
                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xl-6">
                            ...
                            <select class="form-select" disabled>
                                <option value="{{$update->kate_id}}" selected="">{{$update->kategori_investigasi}}</option>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea type="text" class="form-control" rows="20" id="js-ckeditor" name="update_investigasi">
                        {{$update->update_investigasi}}
                        </textarea>
                    </div>
                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-lg-7 offset-lg-4">
                            ...
                            <button type="submit" class="btn btn-alt-primary mt-3"><i class="fa fa-save text-info me-1"></i>Update Data</button>
                        </div>
                    </div>
                </form>
            </div>     
